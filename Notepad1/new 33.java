...
xpathsAccountName_c [0] = "//ns2:AccountName_c";
AccountName_c = "" ;
...
xpathsAccountNumber [0] = "//ns2:PartyNumber";
AccountNumber = "" ;
...
print "+++++++++++++++++++++++++++++++++++++++++++++++";
if(USGME_businessUnit == "Factory of USG Middle East BU"){
response=commerce.fetchCustomerAccount(AccountName_c, usg_customerAccountNumber);
}
else{
...
print outputFormattedAddress ;
        ...
        {  FormattedAddress = get(outputFormattedAddress ,xpathsFormattedAddress [0]);
          ...
          retr=retr+ "1~USG_invoiceToCountry~"+FormattedAddress+"|";
print "+++++++++++++++++++++++++++++++++++++++++++++++";
print retr;
