...
if(line.zm_requestedShipDate=="" OR line.zm_requestedShipDate < line.zm_promisedDate){
	...
	/*if(zm_businessUnit=="KSA Zamil Structural Steel" AND (zm_businessLine =="SSD")){
	firstSplit = split(line._line_item_comment,"^N^");
	count = range(sizeofarray(firstSplit));
	print firstSplit;
	for each in count{
...
if(line._model_name == "Building Parameter"){

	ret = ret + line._document_number + "~buildingNumber_c" + "~" + getconfigattrvalue(line._document_number, "buildingNumber") + "|";
	ret = ret + line._document_number + "~pebdescription_c" + "~" + getconfigattrvalue(line._document_number, "description_bParameter") + "|";

	gable = gable + line.buildingNumber_c+"-"+ getconfigattrvalue(line._document_number, "gableNo_steel") + "@@@";
	bay   = bay + line.buildingNumber_c + "-"+ getconfigattrvalue(line._document_number, "zs_peb_BuildingParam_bayNo") +  "@@@";
	axesWidth = axesWidth + line.buildingNumber_c + "-"+ getconfigattrvalue(line._document_number, "axes1") + "-" + getconfigattrvalue(line._document_number, "axesDescription") +  "@@@";
	axesLength = axesLength + line.buildingNumber_c + "-"+ getconfigattrvalue(line._document_number, "axeslength1") + "-"+ getconfigattrvalue(line._document_number, "axesDescriptionlength") +  "@@@";
	
	
}
if(line._model_name == "Roof Walkways"){
	ret = ret + line._document_number + "~buildingNumber_c" + "~" + getconfigattrvalue(line._document_number, "building_roofwalkway") + "|";
	ret = ret + line._document_number + "~pebdescription_c" + "~" + getconfigattrvalue(line._document_number, "description_roofwalkway") + "|";

}
if(line._model_name == "Roof Monitors"){
	ret = ret + line._document_number + "~buildingNumber_c" + "~" + getconfigattrvalue(line._document_number, "buildings_rfMonitor") + "|";
	//ret = ret + line._document_number + "~pebdescription_c" + "~" + getconfigattrvalue(line._document_number, "description_roofwalkway") + "|";
...
gable1 = substring(gable,0,len(gable)-3);
bay1 = substring(bay,0,len(bay)-3);
axesWidth1 = substring(axesWidth,0,len(axesWidth)-3);
axesLength1 = substring(axesLength,0,len(axesLength)-3);
ret = ret + "1~gable_c" + "~" + gable1 + "|";
ret = ret + "1~bayData_c" + "~" + bay1 + "|";
//ret = ret + "1~axesWidth_BParam_c" + "~" + axesWidth1 + "|";
//ret = ret + "1~axesLength_BParam_c" + "~" + axesLength1 + "|";
ret = ret + "1~axesWidth1_BParam_c" + "~" + axesWidth1 + "|";
ret = ret + "1~axeslength1_BParam_c" + "~" + axesLength1 + "|";
ret = ret + "1~axesWidthRFP_c" + "~" + axesWidth1 + "|";
ret = ret + "1~axesLengthRFP_c" + "~" + axesLength1 + "|";
