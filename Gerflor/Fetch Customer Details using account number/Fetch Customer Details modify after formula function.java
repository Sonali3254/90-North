...
if(accountNumberSearch <> ""){
	response=commerce.fetchCustomerAccount("", accountNumberSearch);
}
print "+++++++++++++++++++++++++++++++++++++++++++++++";
xpathsAccountName_c = string[1];
xpathsAccountName_c [0] = "//ns2:Value/ns2:AccountName";
AccountName_c = "" ;
outputAccountName_c  = readxmlsingle(response, xpathsAccountName_c );
...
if(accountNumberSearch <> ""){
organizationSoapRequest=commerce.findOrganization(AccountName_c );
...
xpathsAccountNumber [0] = "//ns2:Value/ns2:AccountNumber";
AccountNumber = "" ;
outputAccountNumber  = readxmlsingle(response, xpathsAccountNumber );
...
xpathsOrigSystemReference = string[1];
xpathsCustomerClassCode[0] = "//ns2:CustomerClassCode";
xpathsOrigSystemReference[0] = "//ns2:Value/ns2:CustomerAccountSite/ns2:OrigSystemReference";
CustomerClassCode= "" ;
OrigSystemReference = "";
outputCustomerClassCode = readxmlsingle(response, xpathsCustomerClassCode);
outputOrigSystemReference = readxmlsingle(response, xpathsOrigSystemReference);
print outputOrigSystemReference;
if (containskey(outputOrigSystemReference ,xpathsOrigSystemReference [0]))
        {  OrigSystemReference = get(outputOrigSystemReference ,xpathsOrigSystemReference[0]);
          print "&&&&&"; print OrigSystemReference ;
         }
...
print "+++++++++++++++++++++++++++++++++++++++++++++++";
if(isnull(CustomerProfile ) == false ){
...
xpathsSales_Person_c [0] = "//ns2:Value/ns2:CustAcctInformation/ns9:salesPerson";
Sales_Person_c = "" ;
outputSales_Person_c  = readxmlsingle(response, xpathsSales_Person_c );
...
xpathsCustomerBusinessUnitName_c [0] = "//ns2:Value/ns2:CustAcctInformation/ns9:customerBusinessUnitName";
CustomerBusinessUnitName_c = "" ;
outputCustomerBusinessUnitName_c  = readxmlsingle(response, xpathsCustomerBusinessUnitName_c );
...
xpathsSales_Region_c [0] = "//ns2:Value/ns2:CustAcctInformation/ns9:salesRegion";
Sales_Region_c = "" ;
outputSales_Region_c  = readxmlsingle(response, xpathsSales_Region_c );
...
xpathsSales_Area_c [0] = "//ns2:Value/ns2:CustAcctInformation/ns9:salesArea";
Sales_Area_c = "" ;
outputSales_Area_c  = readxmlsingle(response, xpathsSales_Area_c );
...
//xpathsFormattedAddress [0] = "//ns1:FormattedAddress";
//xpathsFormattedAddress [0] = "//ns2:Value/ns2:PartySite[ns1:PartySiteNumber=1045000]/ns1:FormattedAddress";
xpathsFormattedAddress [0] = "//ns2:Value/ns2:PartySite[ns1:PartySiteNumber="+ OrigSystemReference +"]/ns1:FormattedAddress";
FormattedAddress = "" ;
...
print outputCountry ;
	  ...
	  retr=retr+ "1~_transaction_invoiceTo_t_last_name~"+"|";
